...
const artworks = [
...

 {
...

  {
    ...
    description: "A vibrant, magenta-pink blossom stands gracefully in a clear glass vase against a washed turquoise canvas. Dynamic, visible brushstrokes and luminous petals bring a fresh, modern energy to this intimate floral portrait.",
    artistId: 1,
    year: 2024,
    image: "images/artworks/artwork-7.JPEG",
    medium: "Oil on canvas",
    width: 30,
    height: 40,
    unit: "cm",
    ...
    {
    id: 8,
    title: "Peonies in Brass Pitcher",
    description: "Lush, layered peonies in shades of cream, blush, and soft coral gathered in a warm brass pitcher. Set against a soft, golden-sepia background, this classic still life radiates quiet warmth and timeless elegance.",
    artistId: 1,
    year: 2024,
    image: "images/artworks/artwork-8.JPEG",
    medium: "Oil on canvas panel",
    width: 30,
    height: 40,
    unit: "cm",
